    ...
    <nav>
      ...
      <section
        ...
        <div className="lg:flex px-[5px] items-center justify-center m-auto gap-[130px] Laptopmin:px-[40px]  Laptopmin:flex  tabletmin:px-[50px] small:pt-[30px] small:px-[20px]  ">
          ...
          <div className="mb-[5px] tabletmin:pt[90px]">
            {" "}
            <Image src={User} alt="" className="m-[auto]" draggable="false"></Image>
          </div>
        </div>
      </section> 
          ...
          <div>
            <div className="tabletmin:px-[40px] small:px-[15px]">
              <div class="">
                ...
                <div class="about-info-btn mt-30 flex">
                  <a href="#" class="button-1  whitespace-nowrap text-center">
                    My Work <span></span>
                  </a>
      ...
      >
        <div class="services-area ">
          <div class="">
            <div class="row">
              <div class="">
                <div class="section-headding text-center justify-center">
            ...
            <div class="grid grid-cols-3 m-auto gap-[20px]  tabletmin:grid tabletmin:grid-cols-2 tabletmin:gap-[20px] small:flex small:flex-col  small:items-center small:px-[10px] small:justify-center">
              <div class="services-box px-[20px] small:px- small:w-[100%]  py-[35px] text-center rounded-[6px] bg-[#262020] small:flex small:items-center small:justify-center small:flex-col">
                <div class="icon">
                  <FcConferenceCall />
                </div>
              ...
              <div class="services-box px-[20px] small:w-[100%]  py-[35px] text-center rounded-[6px] bg-[#262020]">
                <div class="icon">
                  <FcBusinesswoman />
                </div>
              ...
              <div class="services-box px-[30px]  py-[35px] text-center rounded-[6px] bg-[#262020]">
                <div class="icon">
                  <FcCustomerSupport />
                </div>
              ...
              <div class="services-box px-[20px]  py-[35px] text-center rounded-[6px] bg-[#262020]">
                <div class="icon">
                  <Image src={Edit} alt="" className="h-[50px] w-[50px]" />
                </div>
              ...
              <div class="services-box px-[20px]  py-[35px] text-center rounded-[6px] bg-[#262020]">
                ...
                <h2>Manuscript Refiner</h2>
                <p>
                  Precious creatively enhances manuscripts, making them
                  captivating and ready for publication.
                </p>
              </div>
            </div>
          </div>
      ...
      >
        <div className="bg-[#312f2f] ">
          ...
          <div class="">
            <div class="resume-title my-[40px] text-center ">
            ...
            <div className="flex gap-[35px] justify-evenly px-[50px]  tabletmin:grid tabletmin:grid-cols-2 tabletmin:gap-[20px] small:grid small:grid-cols-1 small:px-[15px]">
              <div class="shadow-custom  bg-[#333333] ">
      ...
      >
        <div className="bg-[#333333] ">
          <div class="">
            ...
            <div class="row">
              <div class="portfolio-list my-10 text-center">
                <ul>
                  <li
                    data-filter="all"
                    class="mixitup-control-active cursor-pointer text-[#fff]"
                  >
                    all
                  </li>
                  ...
                  <li data-filter=".app" class="cursor-pointer text-[#fff]">
                    app
                  </li>
                  <li data-filter=".card1" class="cursor-pointer text-[#fff]">
                    card
                  </li>
                </ul>
              </div>
              <div
                class="portfolio-full grid grid-cols-3 gap-[20px] portF px-[90px] pb-5  tabletmin:grid-cols-2 small:grid-cols-1 small:px-[15px]"
                id="MixItUpF028EA"
              >
                {/* <!-- Single --> */}
                <div class="lg:col-4 md:col-6 mb-30 mix web">
                ...
                {/* <!-- Single --> */}
                <div class="col-lg-4 col-md-6 mb-30 mix card1">
                  <div class="portfolio-item">
...
"
                ...
                {/* <!-- Single --> */}
                <div class="col-lg-4 col-md-6 mb-30 mix web">
                  <div class="portfolio-item">
                    <Image src={portfolio6} alt="Portfolio" />
                    <div class="portfolio-item-overly">
                      <div class="portfolio-item-overly-full">
                        <a
                          class="zoom"
      ...
      >
        <div className="bg-[#333333] py-[50px]">
          ...
          <div class="flex gap-5 px-[55px] tabletmin:grid tabletmin:grid-cols-2 small:grid small:grid-cols-1 small:px-[15px]">
            <div class="col-lg-4 col-md-6 mb-30">
              <div class="blog-single">
                <div class="blog-thumbnail">
                  <Image src={User3} alt="blog-image" />
                  <div class="date-box">
                    <span>
                      8 <br /> Feb
                    </span>
                ...
                <div class="blog-content">
                  ...
                  <a href="#" class="read-more">
                    Read More <i class="fas fa-long-arrow-alt-right"><MdReadMore /></i>
                  </a>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-6 mb-30">
              <div class="blog-single">
                <div class="blog-thumbnail">
                  <Image src={User4} alt="blog-image" />
                  <div class="date-box">
                    <span>
                      8 <br /> Feb
                    </span>
            ...
            <div class="col-lg-4 col-md-6 mb-30">
              <div class="blog-single">
                <div class="blog-thumbnail">
                  <Image src={User5} alt="blog-image" />
                  <div class="date-box">
                    <span>
                      8 <br /> Feb
                    </span>
        ...
        <div className="bg-[#312f2f] py-[50px]">
          ...
          <div class="row">
                  ...
                  <div className="grid grid-cols-2 justify-center gap-4 input-sub tabletmin:grid tabletmin:grid-cols-1">
									...
									<div class="col-12">
										<button class="button-1" type="submit">Submit <span></span></button>
									</div>
								</div>
							</form>
						</div>
      ...
      <Footer>
		...
		<footer class="footer  bg-[#333333]   h-[fit-content] w-[auto] relative flex justify-between tabletmin:items-center  flex-col ">
			<div class="footer-top pt-[-20px] pb-[20px]">
				<div class="">
					<div class="flex flex-row   justify-center  gap-[30px] pt-20 px-[40px] tabletmin:flex-none tabletmin:grid tabletmin:grid-cols-2 tabletmin:gap-[20px] tabletmin:px-[20px] small:px-[15px]  small:grid-cols-1">
						...
						<div class="col-lg-3 col-md-6 w-[300px]">
							<div class="footer-widget-single">
								<h3>Useful Links</h3>
								<ul>
			...
			<div class="footer-bottom pt-[20px] pb-[20px] text-center bg-[#312f2f] w-[100%] ">
				<p className="text-[#ccc] ">@ Copyright <a href="#">CodexUnicTheme</a>  | All Rights Reserved</p>
			</div>
		</footer>
      </Footer>
		{/* <!-- End Footer Area --> */}
      <div class="scroll-area block"  onClick={scrollToTop}>
       <i class="fa fa-angle-up"><FaAngleUp /></i>
    </div>
